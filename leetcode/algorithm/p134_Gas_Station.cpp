 ...
 * 
 * Explanation:
 * You can't j at station 0 or 1, as there is not enough gas to travel to
 * the next station.
 * Let's j at station 2 and fill up with 4 unit of gas. Your tank = 0 + 4 =
 * 4
